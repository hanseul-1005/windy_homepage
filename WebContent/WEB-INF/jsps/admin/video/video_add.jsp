...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">Video 등록</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Video 등록</h5>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <input type="text" id="title" class="form-control" placeholder="영상 제목을 입력하세요.">
                </div>
              </div>
              ...
              <div class="row mb-3">
                ...
                <div class="col-sm-10">
                  <textarea id="description" class="form-control" rows="3" placeholder="영상에 대한 간략한 설명을 입력하세요."></textarea>
                </div>
              </div>
  ...
  function goAdd() {
    ...
    $.ajax({
      type: "POST",
      url: "admin.windy?mode=video_add",
      data: { title: title, youtubeUrl: youtubeUrl, description: description },
      dataType: "json",
