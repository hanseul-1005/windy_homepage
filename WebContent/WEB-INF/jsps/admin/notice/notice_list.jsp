              ...
              <table class="table datatable">
                ...
                <thead>
                  <tr>
                    ...
                    <th style="width: 20%; text-align: center;" data-type="date" data-format="YYYY/DD/MM">작성일</th>
                    <th style="width: 20%; text-align: center;" data-type="date" data-format="YYYY/DD/MM">수정일</th>
                    <th></th>
                  </tr>
                </thead>
                <tbody>
                <%for(int i=0; i<30; i++) {%>
                  <tr>
                    <td style="width: 10%; vertical-align: middle;"><%=i+1 %></td>
                    <td style="width: 30%; vertical-align: middle;">공지사항 제목<%=i+1 %></td>
                    <td style="width: 10%; vertical-align: middle;"><%=(i*10)+1 %></td>
                    <td style="width: 20%; vertical-align: middle;">2005/03/<%=i+1 %></td>
                    <td style="width: 20%; vertical-align: middle;">2005/03/<%=i+1 %></td>
            		<td style="width: 10%; vertical-align: middle;"><button type="button" class="btn btn-outline-danger">삭제</button></td>        
                  </tr>
                  <%} %>
                </tbody>
              </table>
