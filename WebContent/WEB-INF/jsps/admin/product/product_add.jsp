...
<body>
    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active">프로덕트 등록</li>
        </ol>
      </nav>
    </div>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">프로덕트 글 작성</h5>
                ...
                <div class="col-sm-10">
                  <div id="featureList">
                    <div class="feature-row">
                      ...
                      <button type="button" class="btn btn-outline-danger btn-sm" onclick="removeFeature(this)">-</button>
                    </div>
                  </div>
  ...
  function goAdd() {
    ...
    $.ajax({
      type: "POST",
      url: "admin.windy?mode=product_add",
      data: formData,
      processData: false,
      contentType: false,
      dataType: "json",
