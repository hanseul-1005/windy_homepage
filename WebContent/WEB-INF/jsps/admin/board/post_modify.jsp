...
int postId = (post != null) ? post.getPostId() : -1;
%>
<!DOCTYPE html>
<html lang="en">
<head>
  ...
  <link href="windy_admin_css/assets/vendor/boxicons/css/boxicons.min.css" rel="stylesheet">
  <link href="windy_admin_css/assets/vendor/quill/quill.snow.css" rel="stylesheet">
  <link href="windy_admin_css/assets/vendor/quill/quill.bubble.css" rel="stylesheet">
  <link href="windy_admin_css/assets/vendor/remixicon/remixicon.css" rel="stylesheet">
...
<body>
    ...
    <section class="section">
      <div class="row">
        <div class="col-lg-12">
          <div class="card">
            <div class="card-body">
              <h5 class="card-title"><%=boardName%> 글 수정</h5>
              ...
              <form>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <input type="text" id="title" class="form-control" value="<%=post != null ? post.getTitle().replace("\"", "&quot;") : ""%>">
                  </div>
                </div>
                <div class="row mb-3">
                  ...
                  <div class="col-sm-10">
                    <div>
                      <div>
                        <div id="editor" style="min-height: 400px;"><%=post != null ? post.getContent() : ""%></div>
                      </div>
                    </div>
                  </div>
                </div>
  ...
  <script src="windy_admin_css/assets/vendor/apexcharts/apexcharts.min.js"></script>
  <script src="windy_admin_css/assets/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
  <script src="windy_admin_css/assets/vendor/chart.js/chart.umd.js"></script>
  <script src="windy_admin_css/assets/vendor/echarts/echarts.min.js"></script>
  <script src="windy_admin_css/assets/vendor/quill/quill.js"></script>
  ...
  <script src="windy_admin_css/assets/vendor/tinymce/tinymce.min.js"></script>
  <script src="windy_admin_css/assets/vendor/php-email-form/validate.js"></script>
  ...
  function goUpdate() {
    ...
    $.ajax({
      type: "POST",
      url: "admin.windy?mode=board_post_update",
