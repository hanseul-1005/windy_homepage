...
<body>
  ...
  var quillRight  = new Quill('#editorRight',  { theme: 'snow', modules: { toolbar: toolbarOptions, resize: {} } });
  var quillBottom = new Quill('#editorBottom', { theme: 'snow', modules: { toolbar: toolbarOptions, resize: {} } });
  bindImageUpload(quillRight);
  bindImageUpload(quillBottom);
  ...
  function updateThumbBadge() {
    $('.badge-thumb').remove();
    var first = $('#previewArea .img-preview:first');
