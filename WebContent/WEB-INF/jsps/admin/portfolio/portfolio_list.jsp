              ...
              <div class="card top-selling overflow-auto">
                ...
                <div class="card-body pb-0">
                  ...
                  <div style="text-align: right;">	
	              	<button type="button" class="btn btn-outline-primary" onclick="location.href='admin.windy?menu=portfolio_add'">등록</button>
	              </div>
						<div style="display: flex; margin: 0 auto;">
							<!-- AI -->
							<div class="col-lg-2" style="margin-left: 20px; margin-right: 20px; margin-bottom: 5px;">
